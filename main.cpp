...
//        near_state.displaystate();
        ...
        //set malfunciton
        //set u rand (malfunction in generate_input)
...
//        }
    ...
    ofstream myfile;
    myfile.open ("Mini_project_j_graph_points.csv");
    ...
    myfile.open ("Mini_project_j_graph_backward_points.csv");
    ...
    myfile.open ("Mini_project_j_show_path.csv");
    for(int i=0; i<state_record.size(); i++){
...
//    if(g==1){
//        if(malfunciton == 0){
//            float mal = rand() % 100 + 0;
//            if( (mal/100) <= prob_malfunciton )
//                malfunciton=1;
//        }
//    }
    
    if(malfunciton == 0){
        //cout<<"\nNot malfuncitoning now...\n";
        if(g==1){
            float mal = rand() % 100 + 0;
            if( (mal/100) <= prob_malfunciton )
                malfunciton=1;
